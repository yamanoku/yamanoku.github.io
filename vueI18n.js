export default {
  ...
  messages: {
    en: {
      ...
      info: {
        caption:
          "I'm active on the Internet under the name of Oyama-Michinoku, yamanoku. My birthday is October 30, 1989. I was born in Noshiro City, Akita Prefecture. I'm male. Currently, I lives in Nagareyama City, Chiba Prefecture. One daughter's father and three cat owners.",
        birth: "Born in Noshiro, Akita, Japan",
        sex: "Sex - Man",
        2008: {
          before: "Get into Iwate University of Art and Culture Course.",
          now:
            "Now - Art and Culture Course in Faculty of Humanities and Sociology"
        },
        2014: "Get married.",
      ...
      product: {
        ...
        description: {
          ...
          qiitaCode:
            "A Chrome extension that restores Qiita's code style to the previous one. Not published to the store. Therefore, add it in developer mode.",
          birthdayCount:
      ...
      aboutPage: {
        ...
        components: {
          ...
          desc03:
            "In addition, we set the Store to call each API to prevent the depth of Props in component-oriented development."
        },
        pwa: {
          desc01:
        ...
        i18n: {
          ...
          desc02:
            "I support Japanese and English as standard, but we plan to support other languages."
        },
        designDescription:
        ...
        overdesign: {
          ...
          desc02:
            "It's also designed with semantic markup, so you can get to the information without getting stylized or leaving the default style."
        },
        fontSize: {
          desc01:
      ...
      privacyPage: {
        ...
        description:
          "yamanoku.net privacy policy page. Provides information about access analysis tools.",
        analytics: {
          heading: "About Access Analysis Tools",
          desc01:
            "yamanoku.net uses Google's access analysis tool “Google Analytics”.",
          desc02:
            "This Google Analytics server uses cookies to collect access information. This access information is collected anonymously and is not personally identifiable.",
          desc03:
            "Google Analytics cookies on this site will be retained for 26 months. This feature can be rejected by disabling cookies, so please check your browser settings.",
          link01: {
      ...
      error: {
        404: {
          ...
          text02:
            "We apologize for the inconvenience, but please access the relevant page from the site map."
        },
        500: {
          text01:
            "A server error has occurred. Please wait for a while and try again.",
          text02:
            "If it is still not recovered, please contact us via the email address."
        },
        sitemap: {
    ...
    ja: {
      ...
      info: {
        caption:
          "ネット上では、おおやまみちのく、yamanokuと名乗って活動しています。誕生日は1989年10月30日。秋田県能代市生まれ。性別は男性。現在千葉県流山市在住。一児（娘）の父と3匹の猫の飼い主。",
        birth: " 秋田県能代市生まれ",
        sex: "性別 - 男性",
        2008: {
      ...
      career: {
        ...
        desc01:
          "自分のキャリアのスタートはWebデザイナーとしてで、エンジニアから始まったわけではありません。",
        desc02:
        ...
        desc04:
          "私がエンジニアを目指すにあたり実現していきたいことの中に「強固な設計で長く使われてるプロダクト」を作っていくことがあります。それはエンジニアリングだけでは達成できることではなくUIデザインやユーザーの体験、幅広い層に使ってもらうための考慮なども必要となると考えています。難易度が高いことではありますがより良きものを皆が享受できるよう１つずつ課題をこなしていきたいと思っています。"
      },
      product: {
        wafb: {
        ...
        description: {
          wafb:
            "技術書典5にて発表。ウェブアクセシビリティはどういった対応があるのか、マシンリーダブルとヒューマンリーダブル、WAI-ARIAについて、求められるアクセシビリティを意識したウェブページなど、エンジニアだけでなくウェブに関わるすべての人に見てもらいたい一冊です。（アクセシビリティとは、近づきやすさやアクセスのしやすさのこと）",
          reading:
            "いつも自分が見ているニュースを集めてまとめてみたらどうなるだろうか、情報の蓄積・見える化というものを考え作りました。オフラインアプリケーションとしても閲覧できるようPWA技術を取り入れています。",
          vuePortfolio:
            "Vue.js製のポートフォリオテンプレートです。vue-cliから作成したSPA処女作です。はじめはVue1.0系で作ってましたが、Vue2.0系にバージョンアップ対応しています。",
          yamanokuCli:
            "CLIで確認できる簡易自己紹介ツールです。 fork元は sindresorhus氏より。",
          slackprimoji:
            "プリパラキャラのセリフをSlackのリアクション用絵文字に変換。元ネタはoti氏制作の slack-reaction-decomojiより。",
          qiitaCode:
            "Qiitaのcodeスタイルを以前のものに戻すChrome拡張機能。ストアに公開していません。そのため、デベロッパーモードにて追加して使用してください。",
          birthdayCount:
            "yamanokuの誕生日までをカウントダウンしています。当日になったらAmazonの欲しい物リストが公開されます。翌日にはリセットされてふたたびカウントダウンされます。TypeScriptを使用しています。",
          glitch:
            "JavaScriptによるグリッチ表現ツールです。<input type='range'>で調整できます。アップロードして画像を変更できます。グリッチした画像を保存も可能です。",
          browserCrash:
            "WindowsOSでブラウザが重くなったときにおこりそうな状況をcanvas上で表現。カーソルを動かすことによりブラウザが無限に描画されます。 このJavaScriptには違法性はまったくありません。",
      ...
      privacyPage: {
        title: "プライバシーポリシー",
        description:
          "yamanoku.netのプライバシーポリシーページです。アクセス解析ツールについての説明が載っています。",
        analytics: {
          heading: "アクセス解析ツールについて",
          desc01:
            "yamanoku.net（以下、当サイト）では、Googleによるアクセス解析ツール「Googleアナリティクス」を利用しています。",
          desc02:
            "このGoogleアナリティクスはアクセス情報の収集のためにCookieを使用しています。このアクセス情報は匿名で収集されており、個人を特定するものではありません。",
          desc03:
            "当サイトでのGoogleアナリティクスのCookieは、26ヶ月間保持されます。この機能はCookieを無効にすることで収集を拒否することが出来ますので、お使いのブラウザの設定をご確認ください。",
          link01: {
      ...
      error: {
        404: {
          ...
          text02:
            "お手数をおかけしますが、以下サイトマップより対象のページへアクセスしてください。"
        },
        500: {
          text01:
            "サーバエラーが発生しました。恐れ入りますがしばらくお待ちいただいた後再度アクセスしてください。",
          text02:
            "それでも復旧していない場合は、お手数をおかけしますが以下メールよりご連絡ください。"
        },
        sitemap: {
          title: "サイトマップから探す"
        }
    ...
    fr: {
      ...
      info: {
        caption:
          "Je suis actif sur Internet comme Oyama-Michinoku, yamanoku. Mon anniversaire est le 30 octobre 1989. Je suis né à Noshiro City, dans la préfecture d'Akita. Mon sexe est masculin. Je vis actuellement à Nagareyama City, dans la préfecture de Chiba. Un père de fille et trois propriétaires de chats.",
        birth: "Né à Noshiro, Akita, Japon",
        sex: "Sexe - Homme",
        2008: {
          before: "Mettez-vous dans Iwate University of Art et culture Cours.",
          now:
            "À présent - Cours d'art et de culture à la Faculté des sciences humaines et de sociologie"
        },
        2014: "se marier.",
        2016: "Fille est né",
      ...
      product: {
        ...
        description: {
          wafb:
            "Annoncé dans le livre technique 5. C’est un livre que tout le monde sur le Web, et pas seulement les ingénieurs, souhaite voir comment l’accessibilité au Web est prise en charge, telle que lisible par machine, lisible par l’homme et WAI-ARIA.",
          reading:
            "J'ai pensé et créé un stockage d'informations et une visualisation pour voir ce qui se passerait si je rassemblais toujours et rassemblais les nouvelles que je regardais. Intègre la technologie PWA afin qu’elle puisse être visualisée en tant qu’application hors ligne.",
          vuePortfolio:
            "Modèle de portfolio créé par Vue.js. Ceci est un travail vierge SPA créé à partir de vue-cli. Au début, il était fabriqué avec la série Vue1.0, mais sa version est compatible avec la série Vue2.0.",
          yamanokuCli:
            "Il s’agit d’un outil simple d’introduction automatique qui peut être vérifié à l’aide de la CLI. Fork est de sindresorhus.",
          slackprimoji:
            "Convertissez les lignes de caractères pri-para en emoji de réaction lâche. L'histoire originale est tirée de slack-reaction-decomoji produit par oti.",
          qiitaCode:
            "Une extension Chrome qui restaure le style de code de Qiita au précédent. Non publié dans le magasin. Par conséquent, ajoutez-le en mode développeur.",
          birthdayCount:
            "Compte à rebours pour l'anniversaire de Yamanoku. La liste de souhaits d'Amazon sera publiée ce jour-là. Le lendemain, il sera réinitialisé et décompté à nouveau. Ce produit utilise TypeScript.",
          glitch:
            "Un outil d'expression de pépin utilisant JavaScript. Pour ajuster <input type='range'>. Vous pouvez télécharger et modifier l'image. Les images glitched peuvent également être enregistrées.",
          browserCrash:
            "Représente sur la toile la situation susceptible de se produire lorsque le navigateur devient lourd sous Windows. Le navigateur est dessiné indéfiniment en déplaçant le curseur. Ce JavaScript n'est pas illégal du tout.",
      ...
      aboutPage: {
        ...
        description:
          "yamanoku.net est un portail d'Okuto Oyama appelé yamanoku.",
        heading: {
        ...
        markup: {
          desc01:
            "Mise en oeuvre du balisage sémantique pour réaliser la conception de l'information de lisibles par l'homme (On peut comprendre) et lisibles par la machine (Être compris par la machine).",
          desc02:
            "Il met également en oeuvre la réalisation de contenu en utilisant WAI-ARIA (Web Accessibility Initiative - Accessible Rich Internet Applications).",
          caption:
            "Aider les utilisateurs à passer d'un article à l'autre en liant aria-labelledby à des éléments d'article."
        },
        components: {
          desc01:
            "Par exemple, la liste des diapositives utilise les composants suivants pour effectuer le rendu:",
          desc02:
            "Vous devez formater l'API que vous obtenez pour affichage, mais la gestion de celle-ci en tant que composant unique simplifie le code source, permet de multiples utilisations et simplifie la conception des informations.",
          desc03:
            "De plus, nous avons configuré le Store pour appeler chaque API afin d'empêcher la profondeur de Props dans le développement orienté composants."
        },
        pwa: {
          desc01:
            "Lorsque vous naviguez dans Google Chrome, vous pouvez utiliser PWA de bureau à partir de votre PC ou PWA à partir de votre appareil mobile.",
          desc02:
            "Vous pouvez le lancer en tant qu'application native sans passer par un navigateur, utiliser le cache pour obtenir une expérience rapide de la page, ou le télécharger une fois et l'afficher hors ligne."
        },
        i18n: {
          desc01:
            "Depuis que nous développons sur Nuxt.js, nous avons introduit un outil appelé nuxt-18 n. En plus de l'internationalisation, le rendu peut aussi être fait pour des langues spécifiques.",
          desc02:
            "Nous supportons le japonais et l'anglais comme langue de base, mais nous prévoyons de soutenir d'autres langues."
        },
        designDescription:
          "Le design inclusif est incorporé pour faciliter la visualisation de toutes les couches.",
        overdesign: {
          desc01:
            "Trop de décoration peut vous empêcher d'obtenir l'information que vous voulez. Il est conçu avec le style par défaut du navigateur, c'est-à-dire l'image standard en tête.",
          desc02:
            "Il est également implémenté dans un balisage sémantique, de sorte que vous pouvez accéder à l'information sans être stylisé ou laisser le style par défaut."
        },
        fontSize: {
          desc01:
            "Le paramètre de base est 16 px, et le rapport taille est maintenu lorsque la page est agrandie par rem."
        },
        contrast: {
          desc01:
            "Toutes les couleurs ont un rapport de contraste d'au moins 4,5 : 1 avec le fond, mais ils ne sont pas de noir et blanc pur, mais sont plutôt équilibrés avec moins de nuances de gris.",
          desc02:
            "Il est spécifié à l'aide des propriétés personnalisées suivantes (variables CSS) pour une utilisation commune:",
          desc03:
            "Il supporte également le mode sombre (Doux teintes foncées des yeux), selon les paramètres du système d'exploitation."
        },
        maxWidth: {
          desc01:
            "La largeur maximale du contenu principal est de 80ch. ch est appelé chaîne et est une unité variable selon la taille du caractère.",
          desc02:
            "L'avantage de ce paramètre est qu'il peut prendre en charge les utilisateurs atteints de dyslexie qui ne peuvent pas lire de longues phrases, et il est moins probable que certains textes deviennent illisibles à mesure que la taille des caractères augmente."
        },
        verticalRhythm: {
          desc01:
            "Nous utilisons un rythme vertical qui met l'accent sur la cohérence dans toute la page. Les marges et les marges sont définies par rapport à l'espacement des lignes de 24px.",
          desc02:
            "Les utilisateurs souffrant d'une déficience cognitive peuvent lire le texte plus facilement si les mots sont espacés de façon uniforme."
        }
      },
      privacyPage: {
        title: "Politique de confidentialité",
        description:
          "page de politique de confidentialité de yamanoku.net. Fournit des informations sur les outils d'analyse d'accès.",
        analytics: {
          heading: "A propos des outils d'analyse d'accès",
          desc01:
            "yamanoku.net utilise l'outil d'analyse d'accès de Google “Google Analytics”.",
          desc02:
            "Ce serveur Google Analytics utilise des cookies pour collecter des informations d'accès. Ces informations d'accès sont collectées anonymement et ne sont pas personnellement identifiables.",
          desc03:
            "Les cookies de Google Analytics sur ce site seront conservés pendant 26 mois. Cette fonctionnalité peut être rejetée en désactivant les cookies, donc veuillez vérifier les paramètres de votre navigateur.",
          link01: {
      ...
      error: {
        404: {
          ...
          text02:
            "Nous vous prions de bien vouloir nous excuser pour les inconvénients, mais veuillez visiter la page cible à partir de la carte du site."
        },
        500: {
          text01:
            "Une erreur de serveur s'est produite. Veuillez patienter un moment et réessayer.",
          text02:
            "S'il n'a toujours pas été récupéré, veuillez nous contacter par email ci-dessous."
        },
        sitemap: {
